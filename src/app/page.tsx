      ...
      <main className="flex-1">
        ...
        <section className="container py-24">
            ...
            <div className="mx-auto grid justify-center gap-8 sm:grid-cols-1 md:max-w-[64rem] md:grid-cols-3">
                ...
                <Card className="flex flex-col">
                    ...
                    <CardContent className="flex-1 text-center">
                        <CardDescription>
                           Your data is yours. All calculations are performed on your device, ensuring patient privacy and HIPAA compliance.
                        </CardDescription>
                    </CardContent>
                </Card>
            </div>
        ...
        <section className="container py-16 text-center">
             <div className="mx-auto max-w-2xl">
                 <h2 className="text-3xl font-extrabold tracking-tighter sm:text-4xl">Ready to Streamline Your Workflow?</h2>
                 <p className="mt-4 text-lg text-muted-foreground">
                    Sign up today and experience the future of cephalometric analysis. Get your first analyses on us.
                 </p>
                 <div className="mt-8">
                     <Button asChild size="lg">
                         <Link href="/studio">
      ...
      <footer className="py-6 md:px-8 md:py-0 border-t">
          <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
              <p className="text-sm leading-loose text-center text-muted-foreground">
                  Built by the community. All rights reserved.
              </p>
          </div>
      </footer>
    </div>
